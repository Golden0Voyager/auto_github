...
> **生成时间**: 2026-05-23 15:36  
> **精选指标**: 已从 15 个热门候选项目中筛选出 7 个硬核更新。
...
| **`B`** | [huggingface/transformers](https://github.com/huggingface/transformers) | `Python` | ⭐️ 126,000 (95 stars today) | `#Transformers` `#ML` `#Framework`  |
| **`C`** | [comfyanonymous/ComfyUI](https://github.com/comfyanonymous/ComfyUI) | `Python` | ⭐️ 49,000 (180 stars today) | `#ComfyUI` `#StableDiffusion` `#Graph`  |
...
| 评级 | 项目名称 | 主要语言 | 社区热度 | 核心技术标签 |
| :---: | :--- | :---: | :---: | :--- |
| **`B`** | [google-research/sima](https://github.com/google-research/sima) | `Python` | ⭐️ 1,200 (大厂活跃) | `#Agent` `#3D` `#Vision`  |
| **`A`** | [meta-llama/llama3](https://github.com/meta-llama/llama3) | `Python` | ⭐️ 34,000 (大厂活跃) | `#LLM` `#Inference` `#Weights`  |
...
- **基本数据**: `Python` | ⭐️ 126,000 (95 stars today) | **来源**: `trending`
...
- **基本数据**: `Python` | ⭐️ 49,000 (180 stars today) | **来源**: `trending`
